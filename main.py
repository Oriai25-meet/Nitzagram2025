...
def create_post(username, location, description, info=None):
    if info:
        return TextPost(username, location, description, info)
...
def main():
    ...
    Posts = [
        ...
        create_post('WriterGuy', 'London, UK', 'This is a text post!', "Life is beautiful 🌍✨")  # פוסט טקסטואלי חדש
    ]
